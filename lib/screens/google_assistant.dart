...
class GoogleAssistant extends StatefulWidget {
  ...
  @override
  _GoogleAssistantState createState() => _GoogleAssistantState();
}

class _GoogleAssistantState extends State<GoogleAssistant> {
  ...
  BehaviorSubject<List<int>> _audioStream = BehaviorSubject();
